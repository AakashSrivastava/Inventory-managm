...
export class LoginPage {
  ...
  constructor(private storage: Storage, public registerP: RegistrationProvider, public alertCtrl: AlertController, public navCtrl: NavController, public navParams: NavParams) {
  }
  ...
  login() {
    ...
    this.registerP.login(username).subscribe(data => {      
      if (data.msg.email == username.email && data.msg.password == username.password) {        
          this.storage.set('user', data.msg);  
